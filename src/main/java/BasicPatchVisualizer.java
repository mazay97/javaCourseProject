...
public class BasicPatchVisualizer {
    ...
    public BasicPatchVisualizer(String[] args) {
        arguments = args;
    }
    ...
    private void parsePatch() throws IOException {
    ...
    private void generateHtmlData() throws IOException{
    ...
    private void compareFileAndPatch(){
        Comparator comparator = new BasicFileAndPatchComparator(basicPatch, file, sourceFile);
        comparator.compare();
    }
}
